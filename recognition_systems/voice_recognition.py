    ...
    def stop_recognition(self):
        ...
        if self.thread:
            ...
            if self.recognition_attempts > 0:
                ...
                print(f"Recognition stats: {self.successful_recognitions}/{self.recognition_attempts} successful ({success_rate:.1f}%)")
            ...
            try:
                ...
                try:
                    ...
                    if not result or 'alternative' not in result:
                        ...
                        time.sleep(self.pause_after_no_speech)  # Wait before listening again
                        continue
                    ...
                    print(f"Recognized: '{transcript}' with confidence {confidence:.2f}")
                    ...
                    if self.phrases:
                        ...
                        for phrase in self.phrases:
                            similarity = self._calculate_text_similarity(phrase.lower(), transcript.lower())
                        ...
                        if highest_similarity >= phrase_threshold:
                            ...
                            print(f"Detected command: {matched_phrase} with confidence {match_confidence:.2f}")
                            ...
                            print(f"No close match found, best was {matched_phrase} with similarity {highest_similarity:.2f}")
                            time.sleep(self.pause_after_no_speech)  # Wait before listening again
                    else:
...
def main():
    ...
    speech_recognizer = BackgroundSpeechRecognizer(
        ...
        energy_threshold=3500,  # Adjust based on your environment
        dynamic_energy_adjustment=True
    )
    ...
    try:
        while True:
            ...
            command = speech_recognizer.get_latest_speech()
            if command:
                timestamp, text, confidence = command
